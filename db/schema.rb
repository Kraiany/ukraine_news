...
ActiveRecord::Schema.define(version: 20140929120958) do
  ...
  add_index "articles", ["unique_identifier"], name: "index_articles_on_unique_identifier", unique: true, using: :btree
